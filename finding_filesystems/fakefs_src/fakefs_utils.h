...
/**
 * Override standard file system fuctions with our custom functions using
 * LD_PRELOAD env variable See
 * https://stackoverflow.com/questions/426230/what-is-the-ld-preload-trick for
 * more info
 */
...
// Grab pointer to (original implementation of) function fname from its shared
// library and assign it to orig_fname
#define HOOK(fname) orig_##fname = dlsym(RTLD_NEXT, #fname)
// Same as HOOK, but grab realname and assign it to orig_name
