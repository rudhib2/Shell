 ...
 * 	1 - the thread was stopped early because the password
 *      was cracked by another thread
 *  2 - the thread has finished searching in the
 *      range it was given and failed to find the password
 *
 * THIS FUNCTION SHOULD ONLY BE USED IN VERSION 2 OF THIS MP
 */
